    ...
    <div class="card-body">
      <div class="tool-controls">
        <div class="d-flex flex-wrap align-items-center gap-2 mb-2">
          <div class="me-2"><strong>Estaciones</strong></div>
          <div id="stationsWrap" class="station-badges d-flex flex-wrap"></div>
        </div>
        <div class="d-grid controls-grid" style="grid-template-columns: auto auto 1fr; gap:.5rem">
          <div class="btn-group btn-group-sm" role="group" aria-label="Vista">
            <input type="radio" class="btn-check" name="mode" id="modePersona" autocomplete="off" checked>
            <label class="btn btn-outline-secondary" for="modePersona">Persona</label>
            <input type="radio" class="btn-check" name="mode" id="modeAnio" autocomplete="off">
            <label class="btn btn-outline-secondary" for="modeAnio">Año</label>
          </div>
      ...
      <div id="contentPersona">
        <div class="row g-3">
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header d-flex justify-content-between align-items-center">
                <div><strong>TXT</strong> <span id="personaHeadTxt" class="muted"></span></div>
              </div>
              <div class="card-body p-0">
                <div class="table-responsive">
      ...
      <div id="contentAnio" class="d-none">
        <div class="card">
          <div class="card-header d-flex justify-content-between align-items-center">
            <div><strong>Resumen por Año</strong> <span id="anioHead" class="muted"></span></div>
          </div>
          <div class="card-body p-0">
            <div class="table-responsive">
              <table class="table table-sm table-striped mb-0" id="tblAnio">
                <thead>
                  <tr id="tblAnioHead">
                    <th class="w-min d-none" id="thEstacion">Estación</th>
...
<script src="<?= htmlspecialchars(asset_version('assets/pecos_txt.js')) ?>"></script>
</body>
</html>
